...
namespace ElectricalSim
{
    ...
    public static class CircuitTaskCatalog
    {
        ...
        private static CircuitTaskSpec ForwardReverse()
        {
            ...
            Add(task,
                "POWER.L1", "SB0.COM", "SB0.NC", "SBF.COM", "SBF.NO", "KMR.61", "KMR.62", "KMF.A1", "KMF.A2", "POWER.N",
                "SB0.NC", "SBR.COM", "SBR.NO", "KMF.61", "KMF.62", "KMR.A1", "KMR.A2", "POWER.N");
            Add(task, "SBF.COM", "KMF.13", "SBF.NO", "KMF.14", "SBR.COM", "KMR.13", "SBR.NO", "KMR.14");

...
namespace ElectricalSim
{
    public sealed class ContactorView : MonoBehaviour
    {
        ...
        {
            Definition = definition; Runtime = runtime; IsRear = isRear;
            ...
            if (Picker == null) throw new InvalidOperationException("交流接触器 picker 缺失：" + (isRear ? definition.RearModelPath : definition.ModelPath));
